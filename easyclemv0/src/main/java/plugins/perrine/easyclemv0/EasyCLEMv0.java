...
import plugins.perrine.easyclemv0.sequence_listener.RoiChanged;
...
//	private MonitoringConfiguration monitoringConfiguration = new MonitoringConfiguration(false, false);
	...
	private Overlay myoverlaypredictederror;
	private Overlay myoverlayerror;
...
//	}
	...
	protected void initialize() {
		...
		rigidspecificbutton = new GuiCLEMButtons2(workspace);
	...
	protected void execute() {
		...
		workspaceTransformer = new WorkspaceTransformer(
			workspace
		);
